...
$(document).ready(function() {
    ...
    function HeroDead () {
        $(".hiddenrestart").show();
        $(".battlestats").html("<h2>"+"this was the obivous result"+"</h2>").addClass("text-danger").css("font-size","2rem");
        $("#enemyDefeat").text("You are dead haha")
    }
    ...
    $(".attack").on("click", function() {
        ...
        if (cloudherohealth && lelouchenemyhealth) {
            ...
            $("#enemyfight").text("wolverine Attacked For " +lelouchenemyattack);
            ...
            $("#enemyfight").text("hulk Attacked For " +yagamienemyattack);
            ...
            $("#enemyfight").text("cyclops Attacked For " +yugienemyattack);
        ...
        if (lelouchherohealth && cloudenemyhealth) {
            ...
            $("#enemyfight").text("thor Attacked For " +cloudenemyattack);
    ...
    function winMessage() {
        $(".battlestats").text("You win this round!").addClass("text-success").css("font-size","2rem")
        $(".hiddenrestart").show();
